...
let ActionsService = ActionsService_1 = class ActionsService {
    ...
    constructor(crmModel) {
        this.crmModel = crmModel;
    }
    async dispatch(action, payload, tenantId) {
        switch (action.type) {
            case 'notify':
    ...
    async crmUpdate(tenantId, payload) {
...
exports.ActionsService = ActionsService = ActionsService_1 = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(crm_record_schema_1.CrmRecord.name)),
